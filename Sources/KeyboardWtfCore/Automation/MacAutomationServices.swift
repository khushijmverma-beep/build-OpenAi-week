...
public final class DefaultToolRegistry: ToolRegistry {
    ...
    public func schemas() -> [ToolDefinition] {
        [
            ...
            ToolDefinition(name: .composeEmail, description: "Open Gmail in the browser by default, scan the visible screen after each transition, open Compose, fill To, Subject, and message body, and leave the draft unsent. Requires Screen Recording and Accessibility permission. Never click Send.", parameters: [ToolParameter(name: "app", type: .string, description: "Optional email app; omit to open Gmail in the browser", required: false), ToolParameter(name: "to", type: .string, description: "Recipient email address or addresses"), ToolParameter(name: "subject", type: .string, description: "Email subject"), ToolParameter(name: "body", type: .string, description: "Email message body")]),
