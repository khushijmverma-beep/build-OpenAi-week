...
public final class DefaultToolRegistry: ToolRegistry {
    ...
    public func schemas() -> [ToolDefinition] {
        [
            ...
            ToolDefinition(name: .composeEmail, description: "Open or focus the requested email app, open a new compose window, fill the To recipient, Subject, and message body, and leave the draft unsent. Requires Screen Recording and Accessibility permission. Never click Send.", parameters: [ToolParameter(name: "app", type: .string, description: "Email app name such as Mail, Outlook, or Gmail; omit to use Mail", required: false), ToolParameter(name: "to", type: .string, description: "Recipient email address or addresses"), ToolParameter(name: "subject", type: .string, description: "Email subject"), ToolParameter(name: "body", type: .string, description: "Email message body")]),
